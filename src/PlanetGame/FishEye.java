...
/**
 * Created by Pieter on 24/11/2016.
 */
public class FishEye{



    //static String imageString = "/Users/Pieter/IdeaProjects/GitHub/Planet-Game/res/pattern.png";
    public static String imageString = "/Users/Pieter/IdeaProjects/GitHub/Planet-Game/res/moon2.png";


    static BufferedImage startImage, endImage;
    static int[] startPixels, endPixels, imR, imG, imB;
    static int width, height;
    static Image pattern;


    //this object transforms the old image and writes the new image
    public static Image FishEye_Image(BufferedImage img){
        ...
        endImage.setRGB(0, 0, width, height, endPixels, 0, width);

        try {
            Texture texture = BufferedImageUtil.getTexture("", endImage);
            pattern = new Image(texture);
        }catch (IOException e){
